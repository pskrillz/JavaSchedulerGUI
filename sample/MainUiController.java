...
//   *      // the actual actual end parameter
    ...
    /**
     * setCountTable()
     * Sets the count table with a list of CategoryCount objects generated by the db.
     * @param objects ObservableList<CategoryCount>
     */
    @FXML
    ...
    /**
     * filterCountMonth()
     * Used by the radio and by default to set the count report table by month.
     */
    ...
    /**
     * filterCountType()
     * Used by the radio to set the count report table by type.
     */
